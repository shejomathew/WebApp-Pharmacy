...
//				try {
//				User user = new User( "Admin", this.bCryptPasswordEncoder.encode("password"), "Admin", "0011", "admin@gmail.com", "46967838", "default.png");

//					User user = new User( "user1", this.bCryptPasswordEncoder.encode("user"), "user", "001", "user0011@gmail.com", "46967838", "default.png");
